...
class FirstpageExample extends StatefulWidget{
  @override
  State<FirstpageExample> createState()=> _FirstpageExampleState();
}
class _FirstpageExampleState extends State< FirstpageExample>{
          ...
          child: Column(
            children: [
              ...
              child: TextField(
                ...
                decoration: InputDecoration(border: OutlineInputBorder(),labelText: "content"),
              ),
              ),
              SizedBox(height: 35,),
